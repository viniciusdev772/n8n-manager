...
echo ""
DISPLAY_TOKEN=$(grep -oP 'API_AUTH_TOKEN=\K.*' "$PROJECT_DIR/.env" 2>/dev/null || echo "NAO ENCONTRADO")
echo -e "  ${CYAN}Seu token de acesso:${NC}"
echo -e "    ${GREEN}${DISPLAY_TOKEN}${NC}"
echo ""
echo -e "  ${DIM}Use este token para acessar o painel e a API.${NC}"
echo ""
